...
% 设置绘图参数
y_label_2 = 'Mean connectivity clternation';
...
for state = 1:27
    filename = ['D:/ssvepnet/aveconnectstrength/sub_all_aveconnectstrength/aveconectstrength_', num2str(state), '.csv'];
...
output_filename = [output_folder, 'alter_state_all.jpg'];
% 保存图像为JPEG文件
